...
const columns = [
  ...
  { header: "Öğrenci", accessor: "student"},
  { header: "Puan", accessor: "score", className:"hidden md:table-cell"},
  { header: "Öğretmen", accessor: "teacher", className: "hidden md:table-cell" },
  { header: "Sınıf", accessor: "class", className: "hidden md:table-cell"},
  ...
  return (
    <div className='bg-white p-4 rounded-md flex-1 m-4 mt-0'>
      ...
      <div className="flex items-center justify-between">
        <h1 className="hidden md:block text-lg font-semibold">Tüm Sonuçlar</h1>
