...
const columns = [
  ...
  { header:"Öğretmen No", accessor:"teacherId", className:"hidden md:table-cell" },
  { header:"Dersler", accessor:"subjects", className:"hidden md:table-cell" },
  { header:"Sınıflar", accessor:"classes", className:"hidden md:table-cell" },
    ...
    <td>
      <div className="flex items-center gap-2">
        ...
        {role === "admin" && (
          ...
          // </button>
            <FormModal table="öğretmen" type="delete" id={item.id} />
        )}
      </div>
    </td>
  </tr>
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex flex-col md:flex-row items-center gap-4 w-full md:w-auto">
          ...
          <div className="flex items gap-4 self-end">
            ...
            // </button>
            <FormModal table="öğretmen" type="create"/>
            )}
          </div>
        </div>
      </div>
