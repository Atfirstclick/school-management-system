...
const columns = [
  { header: "Etkinlik Adı", accessor: "title" },
  { header: "Öğretmen", accessor: "class" },
  { header: "Tarih", accessor: "Date", className: "hidden md:table-cell" },
  { header: "Başlangıç", accessor: "startTime", className: "hidden md:table-cell"},
  { header: "Bitiş", accessor: "endTime", className: "hidden md:table-cell"},
  ...
  <tr key={item.id} className="border-b border-gray-200 even:bg-slate-50 text-sm hover:bg-KmlPurpleLight">
    ...
    <td>
      <div className="flex items-center gap-2">
        ...
        {role === "admin" && (
          // <button className="w-7 h-7 flex items-center justify-center rounded-full bg-KmlPurple" title="Sil">
  ...
  return (
    <div className='bg-white p-4 rounded-md flex-1 m-4 mt-0'>
      ...
      <div className="flex items-center justify-between">
        <h1 className="hidden md:block text-lg font-semibold">Tüm Etütler</h1>
