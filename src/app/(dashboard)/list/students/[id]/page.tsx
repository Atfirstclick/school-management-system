...
<div className="bg-KmlSky py-6 px-4 rounded-md flex-1 flex gap-4">
  ...
  <div className="w-2/3 flex flex-col justify-between gap-4">
    <h1 className="text-xl font-semibold">Sevgi Yapar</h1>
    ...
    <div className="flex items-center justify-between gap-2 flex-wrap text-xs font-medium">
        ...
        <div className="flex-1 flex gap-4 justify-between flex-wrap">
         ...
         <div className="">
          <h1 text-xl font-semibold >8</h1>
          <span className="text-sm text-gray-400">Ders</span>
         </div>
         </div>
        {/* CARD */}
         ...
         <div className="">
          <h1 text-xl font-semibold >9-C</h1>
          <span className="text-sm text-gray-400">Sınıf</span>
         </div>
         </div>
        </div>
        ...
        <div className="bg-white p-4 rounded-md">
          ...
          <Link className="p-3 rounded-md bg-KmlSkyLight" href="/">Dersler</Link>
          <Link className="p-3 rounded-md bg-KmlPurpleLight" href="/">Öğretmenler</Link>
          <Link className="p-3 rounded-md bg-pink-50" href="/">Testler</Link>
          <Link className="p-3 rounded-md bg-KmlSkyLight" href="/">Ödevler</Link>
          <Link className="p-3 rounded-md bg-KmlYellowLight" href="/">Sonuçlar</Link>
