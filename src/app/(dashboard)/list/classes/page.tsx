...
const columns = [
  { header: "Sınıf Adı", accessor: "name" },
  { header: "Kapasite", accessor: "capacity", className: "hidden md:table-cell" },
  { header: "Şube", accessor: "grade", className: "hidden md:table-cell" },
  { header: "Sorumlu", accessor: "supervisor", className: "hidden md:table-cell" },
